summon slime ~ ~ ~ {Tags:["boss_main"],Size:1,PersistenceRequired:true,CustomName:'{"bold":true,"color":"dark_purple","text":"킹 슬라임"}',attributes:[{id:"max_health",base:100},{id:"attack_damage",base:15},{id:fall_damage_multiplier,base:0},{id:follow_range,base:2048},{id:knockback_resistance,base:1}]}
