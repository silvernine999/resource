...
execute if score summonAnimation boss matches 51 run bossbar set boss_main name {"text": "킹 슬라임","bold": true,"color": "dark_purple"}

execute if score summonAnimation boss matches 60 run function mobs:boss/kingslime/phase/1_start
