...
execute if score @s boss_summons_tick matches 150..180 run rotate @s facing entity @p[distance=..20]
...
execute if score @s boss_summons_tick matches 200..210 rotated ~ 0 if blocks ^ ^ ^1 ^ ^ ^3 0 300 0 masked run tp @s ^ ^ ^2
