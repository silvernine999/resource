summon slime ~ ~ ~ {Tags:["boss_summons","temp_boss_summons","boss_split_small"],Size:1,attributes:[{id:"attack_damage",base:10},{id:fall_damage_multiplier,base:0},{id:follow_range,base:2048},{id:jump_strength,base:.5},{id:scale,base:2.5}],CustomName:'{"bold":true,"color":"dark_purple","text":"분열된 슬라임 (소형)"}'}
