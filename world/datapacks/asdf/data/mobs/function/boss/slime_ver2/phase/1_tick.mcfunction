...
execute if score pattern_cool boss matches 0 if entity @n[tag=boss_main,nbt={OnGround:1b}] as @n[tag=boss_main] at @s run function mobs:boss/slime_ver2/patterns/superjump/start
...
execute if entity @e[tag=boss_main,nbt={Size:0}] run function mobs:boss/slime_ver2/phase/2_start